function ChangeQuote() {
  ...
  var quotes = [
    ...
    {
      quotation: "It is good to love many things, for therein lies the true strength, and whosoever loves much performs much, and can accomplish much, and what is done in love is well done.",
  ...
  function quote(q) {
  	return q.quotation + '<br /><span class="name">' + q.author + '</span>';
  }
